...
const domain = () => {
  return (
    <div className={styles.container}>
      ...
      <h2>A customer writes in to the Helpdesk stating: "I have a custom domain which I purchased at GoDaddy and I want to use it on my project". In a couple of paragraphs, how do you respond?</h2>
      ...
      <p>First I want to direct you to our documentation on setting up <a className={styles.inbedded_link} href='https://vercel.com/docs/concepts/projects/custom-domains' target='_blank'>custom domains</a>.</p>
